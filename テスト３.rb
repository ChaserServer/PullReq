...
count = 0
cat = 0 # 袋小路対策(同じ辺上の斜め2マスが壁で, 挟まれた1マスがアイテムの時, アイテムの奥が壁か否か確認する)
dog = 0   # 斜めの位置に相手がいたときにカウントアップ
ringo = 0 # dogの値が3になったらリンゴの値を１にする. リンゴの値が１の時、敵から
...
def _moshiTonariNiTeki(values, action) # getReadyの隣接する見つかった時の処理
