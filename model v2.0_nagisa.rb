# -*- coding: utf-8 -*-
require_relative './CHaserConnect.rb' #呼び出すおまじない

#　書き換えない
target = CHaserConnect.new("model v2.0.rb") # ()の中好きな名前
values = Array.new(10)
...
def _firstMoving(values, target, i, wallCountA, wallCountB, itemCountA ,itemCountB, judgA, judgB)
...
# ここから実行するメソッドを書いていく
_firstMoving(values, target, i, wallCountA, wallCountB, itemCountA ,itemCountB, judgA, judgB)
